...
public interface FlamePairRDD {
  ...
  FlameRDD flatMap(PairToStringIterable lambda, String persistTable) throws Exception;
  ...
  FlamePairRDD flatMapToPair(PairToPairIterable lambda, String persistTable) throws Exception;
